...
//
//	mockgen -package=mocks -destination=../../../mocks/service/authz.go -source=authz.go UsersServiceConsumer
//
...
// MockUsersServiceConsumer is a mock of UsersServiceConsumer interface.
type MockUsersServiceConsumer struct {
	ctrl     *gomock.Controller
	recorder *MockUsersServiceConsumerMockRecorder
	isgomock struct{}
}

// MockUsersServiceConsumerMockRecorder is the mock recorder for MockUsersServiceConsumer.
type MockUsersServiceConsumerMockRecorder struct {
	mock *MockUsersServiceConsumer
}

// NewMockUsersServiceConsumer creates a new mock instance.
func NewMockUsersServiceConsumer(ctrl *gomock.Controller) *MockUsersServiceConsumer {
	mock := &MockUsersServiceConsumer{ctrl: ctrl}
	mock.recorder = &MockUsersServiceConsumerMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockUsersServiceConsumer) EXPECT() *MockUsersServiceConsumerMockRecorder {
	return m.recorder
}

// SelectAuthz mocks base method.
func (m *MockUsersServiceConsumer) SelectAuthz(ctx context.Context, userID uuid.UUID) (map[string]any, error) {
	m.ctrl.T.Helper()
...
func (mr *MockUsersServiceConsumerMockRecorder) SelectAuthz(ctx, userID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SelectAuthz", reflect.TypeOf((*MockUsersServiceConsumer)(nil).SelectAuthz), ctx, userID)
}
